...
Keplerian elements about any chosen primary. See TRAJECTORIES.md (alongside this
script) for source rationale and the field mapping.
...
Usage (run from the project directory):
    python addons/tools/horizons_trajectory.py voyager_1            # dry run (prints rows)
    python addons/tools/horizons_trajectory.py voyager_1 --write    # upsert into the tables
"""
...
# Tables live in the ivoyager_core submodule.
TABLES_DIR = PROJECT_DIR / "addons" / "ivoyager_core" / "tables"
