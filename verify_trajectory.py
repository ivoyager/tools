...
Usage (run from the project directory; refresh table imports first, since headless
runs use cached table data):
    <godot-console> --path . --import --headless
    python addons/tools/verify_trajectory.py voyager_1 --launch
"""
...
from horizons_trajectory import CRAFT, CENTER_BODY, PROJECT_DIR, date_to_jd, jd_to_sim_seconds
